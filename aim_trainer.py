...
def draw_top_bar(win , elapsed_time , targets_pressed , misses):
    ...
    time_label = LABEL_FONT.render(f"Time : {format_times(elapsed_time)}" , 1 ,"black")
...
def end_screen(win , elapsed_time , targets_pressed , clicks):
    WIN.fill(BG_COLOR)
    time_label = LABEL_FONT.render(f"Time : {format_times(elapsed_time)}" , 1 ,"white")
    speed = round(targets_pressed / elapsed_time , 1)
